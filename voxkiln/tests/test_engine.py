...
# these two exercise the gated-weights probe, which needs the [model]
# extra; on a CPU-only CI env they skip rather than fail (split-execution
# rule: real-model paths run on the Mac)
