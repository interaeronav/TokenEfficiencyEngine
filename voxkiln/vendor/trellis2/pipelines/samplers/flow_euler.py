...
class edict(dict):
    """voxkiln: minimal attribute-dict replacing easydict (LGPL-3.0)."""
...
class FlowEulerSampler(Sampler):
    ...
    def sample(
        ...
        **kwargs
        ...
        # voxkiln defect fix (research 44, upstream issue #63): upstream kept
        # every step's pred_x_t/pred_x_0 tensor alive in these lists - the
        # measured batch-generation memory leak. Nothing at inference reads
        # them, so they are no longer retained.
